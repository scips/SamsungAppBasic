...
define(["jquery", "application/controllers/loading", "application/views/loadingScreen", "application/controllers/screen1", "application/views/screen1Screen", "application/models/input", "application/models/api"], function($, loadingController, loadingView, screen1Controller, screen1View, Input, Api) {
  var Application;
